...
MetronicApp.controller('MyAccidentAddedCtrl', function (AccidentService, $scope, $http, $stateParams, $location, SweetAlert, $timeout, UserService, DTOptionsBuilder, DTColumnBuilder, toaster,  $modal) {
